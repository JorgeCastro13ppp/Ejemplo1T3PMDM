...
public class Biblio extends SQLiteOpenHelper {
    ...
    static String createBDSQL = ("CREATE TABLE Ejemplares (" +
            ...
            "titulo TEXT, autor TEXT, anio TEXT, prestado BOOLEAN)");
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        try{
            ...
            Toast.makeText(contexto,"Error al crear la base de datos: "+e, Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        try{
            ...
            Toast.makeText(contexto,"Error al actualizar la base de datos: "+e,Toast.LENGTH_LONG).show();
        }
    }
}
